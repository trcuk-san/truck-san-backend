...
import { register, login, getProfile, updateProfile, listUsers, deleteUser, updateUser, getProfile2 } from '../controllers/authController';
...
router.get("/profile2", authMiddleware, getProfile2)
